...
export default function AgenteIA() {
  return (
    <section id="agente-ia" className="agente-ia">
      <SectionHeading kicker="Inteligência artificial" title="Agente de IA" />

      <div className="agente-ia__grid">
          ...
          <ul className="agente-ia__list">
            {CAPACIDADES.map((item) => (
              <li key={item} className="agente-ia__list-item">
                <span className="agente-ia__check">✓</span>
                {item}
              </li>
            ))}
          </ul>
        ...
        <aside className="agente-ia__panel">
          <span className="agente-ia__panel-icon">
            <ShieldIcon />
          </span>
          <h3 className="agente-ia__panel-title">Seus dados estão seguros</h3>
