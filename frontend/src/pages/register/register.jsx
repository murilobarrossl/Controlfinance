...
export default function RegisterPage() {
  ...
  // estado do formulário (SUBSTITUIR PELAS APIS DO BACKEND)
  const [form, setForm] = useState({
    nome: "", email: "", celular: "", documento: "", senha: "",
  });
    ...
    <div className="register-page">
      ...
      <div className="register-left">
        ...
        <p className="register-description">
          ...
          despesas e investimentos em um único lugar, com visão clara do seu saldo
          e decisões mais inteligentes para o seu futuro financeiro.
        </p>
          ...
          <div className="register-fields">
            ...
            <div className="register-field">
              ...
              <div className="register-password-wrap">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="register-lock-icon">
                ...
                <button className="register-eye-btn" onClick={() => setShowPassword((v) => !v)}>
                  {showPassword ? (
